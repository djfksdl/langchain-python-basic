...
loader = TextLoader('C://hi_python//langchain-python-basic//restaurant.txt', encoding='utf-8')
...
# 생성된 FAISS 인덱스를 나중에 사용할 수 있도록 "restaurant-faiss"라는 로컬 디렉토리에 저장합니다. 실행하면 생성되어야함. 
